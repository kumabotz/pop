...
var POP = {
  ...
  score: { taps: 0, hit: 0, escaped: 0, accuracy: 0},
...
POP.Touch = function(x, y) {
  ...
  this.remove = false; // flag for removing this entity, POP.update will take
                       // care of this
  ...
  this.render = function() {
    POP.Draw.circle(this.x, this.y, this.r, 'rgba(255,0,0,' +
        this.opacity + ')');
  };
};
